...
class Wave_read:
    ...
    _sampclass -- the sample format (int or float)
              available through the getsampclass() method
    ...
    def getsampclass(self):
        return self._sampclass
    ...
    def _read_fmt_chunk(self, chunk):
        try:
            ...
            raise EOFError from None
        if wFormatTag != WAVE_FORMAT_PCM and wFormatTag != WAVE_FORMAT_EXTENSIBLE and wFormatTag != 3:
